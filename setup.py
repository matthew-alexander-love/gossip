...
class CMakeBuild(build_ext):
    def build_extension(self, ext: CMakeExtension) -> None:
        ...
        # from Python.
        cmake_args = [
            f"-DPYTHON_FE_ENABLED=ON",
            f"-DCMAKE_LIBRARY_OUTPUT_DIRECTORY={extdir}{os.sep}",
            f"-DPYTHON_EXECUTABLE={os.path.join(sys.prefix, 'bin', 'python')}",
...
kwargs = dict(
    ...
    zip_safe=False,
    packages=['gossip'],
    setup_requires=["cmake>=3.13.0", "setuptools>=42", "wheel"],
    long_description=open('README.md').read(), 
    long_description_content_type='text/markdown',
    url="https://github.com/matthew-alexander-love/gossip",
)
